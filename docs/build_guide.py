...
def part_i(made):
    ...
    s.append(bullets([
        ...
        "manifest, in both the installed and upright orientations.",
    ]))
...
def part_ii(made):
    ...
    s.append(figure("architecture",
                    "Figure 8 — The whole application in one process. All "
    ...
    s.append(figure("panel_method",
                    "Figure 9 — A real section discretized into flat panels. "
    ...
    s.append(figure("cp",
                    "Figure 10 — Real inviscid surface pressure for a "
    ...
    s.append(figure("induced",
                    "Figure 12 — The McCormick factor. Close to the ground, "
    ...
    s.append(figure("spec_chain",
                    "Figure 13 — Spec resolution. Each modifier unwraps to "
    ...
    s.append(body(
        ...
        "17), so manufacturing preparation applies on top of the shaped "
